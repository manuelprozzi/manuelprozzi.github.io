...
export const Website = (props) => {
  return (
    <div className="rounded-2xl bg-teal-500">
      <h2 className="px-5 py-2 text-lg text-white">{props.title}</h2>
      <div class="relative rounded-2xl bg-gradient-to-t from-teal-800 to-white">
        <img
          className="h-48 rounded-2xl object-cover mix-blend-multiply"
          src="phsite.png"
          alt="website image"
        />
        <svg
          className="absolute bottom-4 right-24 h-8 fill-white"
          viewBox="0 0 496 512"
        >
        ...
        <a
          className="absolute bottom-4 right-4 text-xl text-white"
          href={props.source}
        >
          Source
        </a>
